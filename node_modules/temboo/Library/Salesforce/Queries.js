...
var GetNextResults = function(session) {
    /*
        Create a new instance of the GetNextResults Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Salesforce/Queries/GetNextResults"
    GetNextResults.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetNextResultsResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetNextResultsInputSet();
    }
...
var GetNextResultsInputSet = function() {
    GetNextResultsInputSet.super_.call(this);
        /*
        ...
        */
        this.set_QueryLocator = function(value) {
            this.setInput("QueryLocator", value);
        }
...
var GetNextResultsResultSet = function(resultStream) {
    GetNextResultsResultSet.super_.call(this, resultStream);    
        /*
        ...
        */
        this.get_NextQueryLocator = function() {
            return this.getResult("NextQueryLocator");
        }
}

util.inherits(GetNextResults, choreography.Choreography);
util.inherits(GetNextResultsInputSet, choreography.InputSet);
util.inherits(GetNextResultsResultSet, choreography.ResultSet);
exports.GetNextResults = GetNextResults;
...
var Query = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Salesforce/Queries/Query"
...
var QueryInputSet = function() {
    QueryInputSet.super_.call(this);
        ...
        */
        this.set_SOQL = function(value) {
            this.setInput("SOQL", value);
        }
...
var QueryResultSet = function(resultStream) {
    QueryResultSet.super_.call(this, resultStream);    
        ...
        */
        this.get_QueryLocator = function() {
            return this.getResult("QueryLocator");
        }
}
