...
var CreateEntry = function(session) {
	...
	*/
    var location = "/Library/RunKeeper/DiabetesMeasurements/CreateEntry"
...
var CreateEntryInputSet = function() {
    CreateEntryInputSet.super_.call(this);
        /*
        Set the value of the Entry input for this Choreo. ((required, json) A JSON string containing the key/value pairs for the diabetes measurement entry to create. See documentation for formatting examples.)
        */
...
var DeleteEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/DiabetesMeasurements/DeleteEntry"
...
var RetrieveEntries = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/DiabetesMeasurements/RetrieveEntries"
...
var RetrieveEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/DiabetesMeasurements/RetrieveEntry"
...
var RetrieveEntryInputSet = function() {
    RetrieveEntryInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the EntryID input for this Choreo. ((required, string) This can be the individual id of the diabetes measurement entry, or you can pass the full uri for the entry as returned from the RetrieveEntries Choreo (i.e. /diabetes/24220709).)
        */
        this.set_EntryID = function(value) {
            this.setInput("EntryID", value);
        }
...
var UpdateEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/DiabetesMeasurements/UpdateEntry"
...
var UpdateEntryInputSet = function() {
    UpdateEntryInputSet.super_.call(this);
        /*
        Set the value of the Entry input for this Choreo. ((required, json) A JSON string containing the key/value pairs for the fields to be updated in the diabetes entry. See documentation for formatting examples.)
        */
        this.set_Entry = function(value) {
            this.setInput("Entry", value);
        }
        ...
        */
        ...
        /*
        Set the value of the EntryID input for this Choreo. ((required, string) This can be the individual id of the diabetes entry, or you can pass the full uri for the entry as returned from the RetrieveEntries Choreo (i.e. /diabetes/24085455).)
        */
        this.set_EntryID = function(value) {
            this.setInput("EntryID", value);
        }
