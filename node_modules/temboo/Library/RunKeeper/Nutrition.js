...
var CreateEntry = function(session) {
	...
	*/
    var location = "/Library/RunKeeper/Nutrition/CreateEntry"
...
var DeleteEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/Nutrition/DeleteEntry"
...
var RetrieveEntries = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/Nutrition/RetrieveEntries"
...
var RetrieveEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/Nutrition/RetrieveEntry"
...
var RetrieveEntryInputSet = function() {
    RetrieveEntryInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the EntryID input for this Choreo. ((required, string) This can be the individual id of the nutrition entry, or you can pass the full uri for the entry as returned from the RetrieveEntries Choreo (i.e. /nutrition/-12985593-1350950400000).)
        */
        this.set_EntryID = function(value) {
            this.setInput("EntryID", value);
        }
...
var UpdateEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/Nutrition/UpdateEntry"
