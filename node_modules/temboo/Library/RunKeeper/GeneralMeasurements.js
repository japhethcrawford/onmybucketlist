...
var CreateEntry = function(session) {
	...
	*/
    var location = "/Library/RunKeeper/GeneralMeasurements/CreateEntry"
...
var DeleteEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/GeneralMeasurements/DeleteEntry"
...
var DeleteEntryInputSet = function() {
    DeleteEntryInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the EntryID input for this Choreo. ((required, string) This can be the individual id of the body measurement entry, or you can pass the full uri for the entry as returned from the RetrieveEntries Choreo (i.e. /generalMeasurements/-12985593-1351036800000).)
        */
...
var RetrieveEntries = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/GeneralMeasurements/RetrieveEntries"
...
var RetrieveEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/GeneralMeasurements/RetrieveEntry"
...
var UpdateEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/GeneralMeasurements/UpdateEntry"
