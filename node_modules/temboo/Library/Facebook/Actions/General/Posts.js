...
var CreatePost = function(session) {
    /*
        Create a new instance of the CreatePost Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/General/Posts/CreatePost"
    CreatePost.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new CreatePostResultSet(resultStream);
    }
...
var CreatePostInputSet = function() {
    CreatePostInputSet.super_.call(this);
        /*
...
var CreatePostResultSet = function(resultStream) {
    CreatePostResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(CreatePost, choreography.Choreography);
util.inherits(CreatePostInputSet, choreography.InputSet);
util.inherits(CreatePostResultSet, choreography.ResultSet);
...
var DeletePost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/General/Posts/DeletePost"
...
var ReadPosts = function(session) {
    /*
        Create a new instance of the ReadPosts Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/General/Posts/ReadPosts"
    ReadPosts.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ReadPostsResultSet(resultStream);
    }
...
var ReadPostsInputSet = function() {
    ReadPostsInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
        ...
        /*
        Set the value of the ActionID input for this Choreo. ((optional, string) The id of an action to retrieve. If an id is not provided, a list of all post actions will be returned.)
        */
        this.set_ActionID = function(value) {
            this.setInput("ActionID", value);
        }
...
var ReadPostsResultSet = function(resultStream) {
    ReadPostsResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Facebook. Corresponds to the ResponseFormat input. Defaults to JSON.)
        */
        this.get_Response = function() {
...
util.inherits(ReadPosts, choreography.Choreography);
util.inherits(ReadPostsInputSet, choreography.InputSet);
util.inherits(ReadPostsResultSet, choreography.ResultSet);
...
var UpdatePost = function(session) {
    /*
        Create a new instance of the UpdatePost Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/General/Posts/UpdatePost"
    UpdatePost.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new UpdatePostResultSet(resultStream);
    }
...
var UpdatePostInputSet = function() {
    UpdatePostInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var UpdatePostResultSet = function(resultStream) {
    UpdatePostResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Facebook. Corresponds to the ResponseFormat input. Defaults to JSON.)
        */
        this.get_Response = function() {
...
util.inherits(UpdatePost, choreography.Choreography);
util.inherits(UpdatePostInputSet, choreography.InputSet);
util.inherits(UpdatePostResultSet, choreography.ResultSet);
