...
var CreateListen = function(session) {
    /*
        Create a new instance of the CreateListen Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Music/Listens/CreateListen"
    CreateListen.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new CreateListenResultSet(resultStream);
    }
...
var CreateListenInputSet = function() {
    CreateListenInputSet.super_.call(this);
        /*
        ...
        */
        this.set_Musician = function(value) {
        ...
        */
        this.set_Paused = function(value) {
        ...
        */
        this.set_RadioStation = function(value) {
        ...
        */
        this.set_ViaUser = function(value) {
...
var CreateListenResultSet = function(resultStream) {
    CreateListenResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(CreateListen, choreography.Choreography);
util.inherits(CreateListenInputSet, choreography.InputSet);
util.inherits(CreateListenResultSet, choreography.ResultSet);
...
var DeleteListen = function(session) {
    /*
        Create a new instance of the DeleteListen Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Music/Listens/DeleteListen"
    DeleteListen.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new DeleteListenResultSet(resultStream);
    }
...
var DeleteListenInputSet = function() {
    DeleteListenInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var DeleteListenResultSet = function(resultStream) {
    DeleteListenResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(DeleteListen, choreography.Choreography);
util.inherits(DeleteListenInputSet, choreography.InputSet);
util.inherits(DeleteListenResultSet, choreography.ResultSet);
exports.DeleteListen = DeleteListen;
...
var ReadListens = function(session) {
    /*
        Create a new instance of the ReadListens Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Music/Listens/ReadListens"
    ReadListens.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ReadListensResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new ReadListensInputSet();
    }
...
var ReadListensInputSet = function() {
    ReadListensInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
        ...
        /*
        Set the value of the ActionID input for this Choreo. ((optional, string) The id of an action to retrieve. If an id is not provided, a list of all listen actions will be returned.)
        */
        this.set_ActionID = function(value) {
            this.setInput("ActionID", value);
        }
...
var ReadListensResultSet = function(resultStream) {
    ReadListensResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Facebook. Corresponds to the ResponseFormat input. Defaults to JSON.)
        */
        this.get_Response = function() {
...
util.inherits(ReadListens, choreography.Choreography);
util.inherits(ReadListensInputSet, choreography.InputSet);
util.inherits(ReadListensResultSet, choreography.ResultSet);
exports.ReadListens = ReadListens;
...
var UpdateListen = function(session) {
    /*
        Create a new instance of the UpdateListen Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Music/Listens/UpdateListen"
    UpdateListen.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new UpdateListenResultSet(resultStream);
    }
...
var UpdateListenInputSet = function() {
    UpdateListenInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var UpdateListenResultSet = function(resultStream) {
    UpdateListenResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Facebook. Corresponds to the ResponseFormat input. Defaults to JSON.)
        */
        this.get_Response = function() {
...
util.inherits(UpdateListen, choreography.Choreography);
util.inherits(UpdateListenInputSet, choreography.InputSet);
util.inherits(UpdateListenResultSet, choreography.ResultSet);
