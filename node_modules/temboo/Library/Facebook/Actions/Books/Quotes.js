...
var CreateQuote = function(session) {
    /*
        Create a new instance of the CreateQuote Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Books/Quotes/CreateQuote"
    CreateQuote.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new CreateQuoteResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new CreateQuoteInputSet();
    }
...
var CreateQuoteInputSet = function() {
    CreateQuoteInputSet.super_.call(this);
        /*
...
var CreateQuoteResultSet = function(resultStream) {
    CreateQuoteResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(CreateQuote, choreography.Choreography);
util.inherits(CreateQuoteInputSet, choreography.InputSet);
util.inherits(CreateQuoteResultSet, choreography.ResultSet);
...
var DeleteQuote = function(session) {
    /*
        Create a new instance of the DeleteQuote Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Books/Quotes/DeleteQuote"
    DeleteQuote.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new DeleteQuoteResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new DeleteQuoteInputSet();
    }
...
var DeleteQuoteInputSet = function() {
    DeleteQuoteInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var DeleteQuoteResultSet = function(resultStream) {
    DeleteQuoteResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(DeleteQuote, choreography.Choreography);
util.inherits(DeleteQuoteInputSet, choreography.InputSet);
util.inherits(DeleteQuoteResultSet, choreography.ResultSet);
...
var ReadQuotes = function(session) {
    /*
        Create a new instance of the ReadQuotes Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Books/Quotes/ReadQuotes"
    ReadQuotes.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ReadQuotesResultSet(resultStream);
    }
...
var ReadQuotesInputSet = function() {
    ReadQuotesInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var ReadQuotesResultSet = function(resultStream) {
    ReadQuotesResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(ReadQuotes, choreography.Choreography);
util.inherits(ReadQuotesInputSet, choreography.InputSet);
util.inherits(ReadQuotesResultSet, choreography.ResultSet);
...
var UpdateQuote = function(session) {
    /*
        Create a new instance of the UpdateQuote Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Books/Quotes/UpdateQuote"
    UpdateQuote.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new UpdateQuoteResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new UpdateQuoteInputSet();
    }
...
var UpdateQuoteInputSet = function() {
    UpdateQuoteInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var UpdateQuoteResultSet = function(resultStream) {
    UpdateQuoteResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(UpdateQuote, choreography.Choreography);
util.inherits(UpdateQuoteInputSet, choreography.InputSet);
util.inherits(UpdateQuoteResultSet, choreography.ResultSet);
