...
var CreateBike = function(session) {
    /*
        Create a new instance of the CreateBike Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Fitness/Bikes/CreateBike"
    CreateBike.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new CreateBikeResultSet(resultStream);
    }
...
var CreateBikeInputSet = function() {
    CreateBikeInputSet.super_.call(this);
        /*
...
var CreateBikeResultSet = function(resultStream) {
    CreateBikeResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(CreateBike, choreography.Choreography);
util.inherits(CreateBikeInputSet, choreography.InputSet);
util.inherits(CreateBikeResultSet, choreography.ResultSet);
...
var DeleteBike = function(session) {
    /*
        Create a new instance of the DeleteBike Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Fitness/Bikes/DeleteBike"
    DeleteBike.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new DeleteBikeResultSet(resultStream);
    }
...
var DeleteBikeInputSet = function() {
    DeleteBikeInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var DeleteBikeResultSet = function(resultStream) {
    DeleteBikeResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(DeleteBike, choreography.Choreography);
util.inherits(DeleteBikeInputSet, choreography.InputSet);
util.inherits(DeleteBikeResultSet, choreography.ResultSet);
...
var ReadBikes = function(session) {
    /*
        Create a new instance of the ReadBikes Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Fitness/Bikes/ReadBikes"
    ReadBikes.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ReadBikesResultSet(resultStream);
    }
...
var ReadBikesInputSet = function() {
    ReadBikesInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var ReadBikesResultSet = function(resultStream) {
    ReadBikesResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(ReadBikes, choreography.Choreography);
util.inherits(ReadBikesInputSet, choreography.InputSet);
util.inherits(ReadBikesResultSet, choreography.ResultSet);
exports.ReadBikes = ReadBikes;
...
var UpdateBike = function(session) {
    /*
        Create a new instance of the UpdateBike Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Actions/Fitness/Bikes/UpdateBike"
    UpdateBike.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new UpdateBikeResultSet(resultStream);
    }
...
var UpdateBikeInputSet = function() {
    UpdateBikeInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var UpdateBikeResultSet = function(resultStream) {
    UpdateBikeResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(UpdateBike, choreography.Choreography);
util.inherits(UpdateBikeInputSet, choreography.InputSet);
util.inherits(UpdateBikeResultSet, choreography.ResultSet);
