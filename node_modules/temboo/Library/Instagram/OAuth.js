...
var FinalizeOAuth = function(session) {
	...
	*/
    var location = "/Library/Instagram/OAuth/FinalizeOAuth"
...
var InitializeOAuth = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Instagram/OAuth/InitializeOAuth"
...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Scope input for this Choreo. ((optional, string) The scope of the access you're requesting from the user. Valid values are: basic, comments, relationships, and likes. Multiple scope values should separated by spaces.)
        */
