...
var FinalizeOAuth = function(session) {
	...
	*/
    var location = "/Library/Google/OAuth/FinalizeOAuth"
...
var FinalizeOAuthInputSet = function() {
    FinalizeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ClientSecret input for this Choreo. ((required, string) The Client Secret provided by Google after registering your application.)
        */
...
var InitializeOAuth = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/OAuth/InitializeOAuth"
