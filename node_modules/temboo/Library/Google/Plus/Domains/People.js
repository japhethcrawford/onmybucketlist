...
var Get = function(session) {
	...
	*/
    var location = "/Library/Google/Plus/Domains/People/Get"
...
var List = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Plus/Domains/People/List"
...
var ListInputSet = function() {
    ListInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Collection input for this Choreo. ((required, string) The collection to list people for. Currently the only allowed value for this parameter is: "circled".)
        */
...
var ListByActivity = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Plus/Domains/People/ListByActivity"
...
var ListByActivityInputSet = function() {
    ListByActivityInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ActivityID input for this Choreo. ((conditional, string) The ID of the activity to get the list of people for.)
        */
        ...
        */
        ...
        /*
        Set the value of the Collection input for this Choreo. ((required, string) The collection of people to list.  Acceptable values are: "plusoners","resharers", "sharedto":)
        */
        this.set_Collection = function(value) {
            this.setInput("Collection", value);
        }
...
var ListByCircle = function(session) {
    /*
        Create a new instance of the ListByCircle Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Plus/Domains/People/ListByCircle"
    ListByCircle.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ListByCircleResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new ListByCircleInputSet();
    }
...
var ListByCircleInputSet = function() {
    ListByCircleInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((optional, string) A valid access token retrieved during the OAuth process. This is required unless you provide the ClientID, ClientSecret, and RefreshToken to generate a new access token.)
        */
        this.set_AccessToken = function(value) {
...
var ListByCircleResultSet = function(resultStream) {
    ListByCircleResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "NewAccessToken" output from this Choreo execution. ((string) Contains a new AccessToken when the RefreshToken is provided.)
        */
        this.get_NewAccessToken = function() {
...
util.inherits(ListByCircle, choreography.Choreography);
util.inherits(ListByCircleInputSet, choreography.InputSet);
util.inherits(ListByCircleResultSet, choreography.ResultSet);
exports.ListByCircle = ListByCircle;
