...
var Delete = function(session) {
	...
	*/
    var location = "/Library/Google/Drive/Replies/Delete"
...
var DeleteInputSet = function() {
    DeleteInputSet.super_.call(this);
        ...
        */
        this.set_ReplyID = function(value) {
            this.setInput("ReplyID", value);
        }
...
var Get = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Drive/Replies/Get"
...
var Insert = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Drive/Replies/Insert"
...
var InsertInputSet = function() {
    InsertInputSet.super_.call(this);
        /*
        Set the value of the RequestBody input for this Choreo. ((required, json) A JSON representation of fields in a reply resource. The JSON string must contain a key for content or verb. See documentation for formatting examples.)
        */
...
var List = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Drive/Replies/List"
...
var Update = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Drive/Replies/Update"
...
var UpdateInputSet = function() {
    UpdateInputSet.super_.call(this);
        /*
        Set the value of the RequestBody input for this Choreo. ((required, json) A JSON representation of fields in a reply resource. The JSON string must contain a key for content. See documentation for formatting examples.)
        */
        this.set_RequestBody = function(value) {
            this.setInput("RequestBody", value);
        }
